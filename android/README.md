...
```gradle
dependencies {
    implementation 'com.github.apiverve:domainexpiration-api:1.1.12'
}
```
...
```java
import com.apiverve.domainexpiration.DomainExpirationAPIClient;
import com.apiverve.domainexpiration.APIResponse;
import com.apiverve.domainexpiration.APIException;

// Initialize the client
DomainExpirationAPIClient client = new DomainExpirationAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/domainexpiration](https://docs.apiverve.com/ref/domainexpiration)
...
- **Documentation:** [https://docs.apiverve.com/ref/domainexpiration](https://docs.apiverve.com/ref/domainexpiration)
- **Issues:** [GitHub Issues](https://github.com/apiverve/domainexpiration-api/issues)
