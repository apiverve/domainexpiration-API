...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/domainexpiration',
        'Source': 'https://github.com/apiverve/domainexpiration-api',
        'Bug Tracker': 'https://github.com/apiverve/domainexpiration-api/issues'
    },
    classifiers=[
